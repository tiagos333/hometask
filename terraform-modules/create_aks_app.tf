...
module "install_helm_wordpress"{
  ...
  helm_chart_key1           = "image.tag"
  helm_chart_value1         = "latest"
  helm_chart_key2           = "wordpressUsername"
  helm_chart_value2         = "admin"
  helm_chart_key3           = "wordpressPassword"
  helm_chart_value3         = "admin"
}